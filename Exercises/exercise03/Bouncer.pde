...
class Bouncer {
  ...
  //CHANGED: if you click the mouse while the x position is smaller than half of the screen's width, the object's velocity will speed up by five pixels per frame
  //aditionally: if you click the mouse while the y position is bigger than half of the screen's height, the object's velocity will slow down by five pixels per frame
  void mouseClicked() {
